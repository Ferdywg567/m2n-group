...
class Bahan extends Model
{
    use SoftDeletes;
    protected $fillable = [
        'kode_bahan', 'tanggal_masuk', 'sisa_bahan', 'no_surat', 'nama_bahan', 'jenis_bahan', 'warna', 'vendor', 'status', 'kode_transaksi', 'sku', 'detail_sub_kategori_id', 'panjang_bahan_diambil', 'tanggal_keluar', 'panjang_bahan'
    ];
