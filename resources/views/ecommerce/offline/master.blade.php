...
<head>
    ...
    <title>@yield('title') &dash; M2N Group System</title>
    ...
    <div id="app">
        <div class="main-wrapper">
            ...
            <nav class="navbar navbar-expand-lg main-navbar" style="background-color: white" id="non-printable">
                @include('ecommerce.offline.include.topnav')
            </nav>
            <div class="main-sidebar sidebar-style-2" id="non-printable">
                @include('ecommerce.offline.include.sidebar')
            </div>
            ...
            <footer class="main-footer" id="non-printable">
                @include('ecommerce.offline.include.footer')
            </footer>
        </div>
    </div>
