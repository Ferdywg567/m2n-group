...
<body>
    ...
    <header class="clearfix">
        ...
        <h1>{{$trans->kode_transaksi}}</h1>
        <div id="project">

            <div><h4>Tanggal Transaksi:  {{$trans->tgl_transaksi}}</h4></div>
    ...
    <main>
        <table>
            ...
            <tbody>
                @forelse ($trans->detail_transaksi as $item)
                <tr>
                ...
                <tr>
                    ...
                    <td class="total">@rupiah($trans->total_harga)</td>
                </tr>
                <tr>
                    <td colspan="5">Bayar</td>
                    <td class="total">@rupiah($trans->bayar)</td>
                </tr>
                <tr>
                    <td colspan="5">Kembalian</td>
                    <td class="total">@rupiah($trans->kembalian)</td>
                </tr>
