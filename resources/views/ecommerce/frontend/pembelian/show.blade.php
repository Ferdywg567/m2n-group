...
<div class="breadcrumb-area bg-white" style="margin-top: -2%">
    <div class="container">
        <div class="row">
            <div class="col-md-2">
                <a  href="{{route('frontend.user.pembelian.index')}}" class="text-left"><i
                                                            ...
                                                            <div class="col-md-12">
                                                                <div>
                                                                    <div style="display:inline-block">
                                                                        <h3>{{$transaksi->alamat->jenis_alamat}} {{$transaksi->alamat->kota}} </h3>
                                                                    </div>

                                                                </div>
                                                                <div class="pt-20">
                                                                    <div style="display:inline-block">
                                                                        <h4>{{$transaksi->alamat->nama_penerima}} </h4>
                                                                    </div>

                                                                </div>
                                                                <div class="pt-5">
                                                                    <p>{{$transaksi->alamat->no_telp}}</p>
                                                                    <p style="margin-top:-5px">{{$transaksi->alamat->alamat_detail}}, {{$transaksi->alamat->kecamatan}}, {{$transaksi->alamat->kota}}, {{$transaksi->alamat->kode_pos}}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <h5 class="card-title font-weight-bold ">
                                                                <span class="mr-4"> Pembelian
                                                                    {{date('j F
                                                                    Y',strtotime($transaksi->created_at))}}</span>
                                                                <span class="mr-4"
