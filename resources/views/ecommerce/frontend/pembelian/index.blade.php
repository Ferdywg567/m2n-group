                                                                        ...
                                                                        <h5 class="card-title font-weight-bold ">
                                                                            ...
                                                                            @if ($item->status_bayar == 'sudah di upload')
                                                                                <span
                                                                                    ...
                                                                                    VERIFIKASI</span>
                                                                            @elseif ($item->status_bayar == 'sudah dibayar' && $item->status == 'dikirim')
                                                                                <span
                                                                            ...
                                                                            @elseif ($item->status_bayar == 'sudah dibayar')
                                                                                ...
                                                                                @else
                                                                                    <span
                                                                                        class="badge badge-warning p-2">PROSES
                                                                                        KIRIM</span>
                                                                                @endif
                                                                            @elseif ($item->status_bayar == 'dibatalkan')
                                                                                <span
                                                                                    class="badge badge-danger p-2">DIBATALKAN
                                                                                    - </span>
                                                                            @endif
                                                                            ...
                                                                            <div class="row mt-1">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <h5 class="font-weight-bold mt-2">
                                                                                        {{ "{$row->produk->nama_produk} - {$row->produk->sub_kategori} {$row->produk->kategori}" }}
                                                                                    </h5>
                                                                                    <h5
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 text-right">
                                                                        <a href="{{ route('frontend.user.pembelian.show', [$item->id]) }}"
                                                                            style="font-size: 12px;color:#FF3B30">Lihat
                                                                            Detail</a>
                                                                        @if (in_array($item->status, ['dikirim', 'retur']))
                                                                            <button type="button"
                                                                        ...
                                                                        @if ($item->status == 'telah tiba' && !$item->ulasan()->exists())
                                                                            <button type="button"
                ...
                <form action="" method="post" id="formReview">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <textarea name="ulasan" id="ulasan" class="form-control" placeholder="Tulis ulasan disini"></textarea>
                        </div>
