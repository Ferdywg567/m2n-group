@php
    $kategori = \App\SubKategori::select('nama_kategori')
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-2 col-lg-2">
                        <div class="logo-img">
                            <a href="{{ route('landingpage.index') }}"><img src="{{ asset('/assets/img/M2N 1.png') }}"
                                    width="40%" alt="logo">
                            ...
                            <div class="categori-style-1">
                                <select class="nice-select nice-select-style-1" id="cari_kategori">
                                    <option value="Semua Kategori"
                                        @if (isset($data)) @if ($data == 'Semua Kategori')
                                        selected @endif
                                        @endif>Semua Kategori</option>
                                    @forelse ($kategori as $item)
                                        <option value="{{ $item->nama_kategori }}"
                                            @if (isset($data)) @if ($data == $item->nama_kategori) selected @endif
                                            @endif>
                                            {{ strlen($item->nama_kategori) > 17 ? substr($item->nama_kategori, 0, 14) . '...' : $item->nama_kategori }}
                                        </option>
                                        @empty
                                        @endforelse
                            ...
                            <div class="header-action header-action-flex float-left">
                                <div class="same-style-2 d-flex justify-content-center align-items-center header-item header-cart">
                                    ...
                                    @if (auth()->check())
                                        ...
                                        @endif
                                    @else
                                        <a class="cart header-icon" href="{{ route('frontend.auth.login') }}">
                                            <i class="ri-shopping-cart-line"></i>
                                        </a>
                                    @endif
                                ...
                                <div class="same-style-2 d-flex justify-content-center align-items-center header-item mt-1">
                                    @if (auth()->check())
                                        ...
                                        @endif
                                    @else
                                        <a class="header-icon" href="{{ route('frontend.auth.login') }}">
                                            <i class="ri-notification-2-line"></i><span class="pro-count"></span>
                                        </a>
                                        ...
                                        @if (auth()->user()->hasRole('ecommerce'))
                                            <a href="#" data-toggle="dropdown" aria-haspopup="true"
                                                ...
                                                @if (!empty(auth()->user()->foto))
                                                    <img class="rounded-circle mr-2"
                                                        ...
                                                        alt="Card image cap" style="width:30px">
                                                @else
                                                    <img src="{{ asset('assets/img/avatar/avatar-3.png') }}"
                                                        style="width:30px" class="rounded-circle mr-2" alt="Card image cap">
                                                @endif

                                                {{-- {{\AppHelper::instance()->nama_header(auth()->user()->name)}} --}}
                                            ...
                                            <div class="dropdown-menu" style="width: 70%">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('frontend.user.pembelian.index') }}"
                                                    style="font-size:16px">Pembelian</a>
                                                <a class="dropdown-item" href="{{ route('frontend.favorit.index') }}"
                                                    style="font-size:16px">Favorit</a>
