...
@section('content')
    {{-- <div class="mobile-header-active mobile-header-wrapper-style">
        <div class="clickable-sidebar-wrap">
                ...
                <ul class="splide__list">
                    @forelse ($banner as $item)
                        <li class="splide__slide">
                            <img src="{{ asset('uploads/images/banner/' . $item->gambar) }}" alt="{{ $item->gambar }}">
                        </li>
                    @empty
                    @endforelse
                </ul>
        ...
        <div class="container">
            <div class="section-title-tab-wrap border-bottom-3 mb-30 pb-15">
                ...
                <div class="tab-style-3 nav">
                    <a href="{{ route('frontend.product.kategori') }}?kategori=Semua Kategori" class="active">Lihat Semua
                        Produk </a>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-6">
                            <div class="single-product-wrap mb-35 shadow rounded">
                                ...
                                <div class="product-content-wrap-2 text-left ml-2">
                                    ...
                                    <h3 style="text-overflow: ellipsis; overflow: hidden; white-space: nowrap"><a
                                            href="{{ route('frontend.product.show', [$item->id]) }}">{{ ucwords($item->nama_produk) }}</a>
                                    </h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-12" style="border: none">
                        <div class="banner-wrap mb-10" style="border: none">
                            <div class="banner-img  banner-img-zoom">
                                <a href="#"><img src="{{ asset('uploads/images/banner/' . $item->gambar) }}"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-6">
                            <div class="single-product-wrap mb-35 shadow rounded">
                                <div class="product-img product-img-zoom mb-15">
                                    ...
                                    <div class="product-action-2 tooltip-style-2">
                                        <button title="Wishlist" data-id="{{ $item->id }}" class="wishlist-bottom"
                                            @if (auth()->check()) @if (\AppHelper::instance()->favorit_data(auth()->user()->id, $item->id)) style="background-color:black;color:white" @endif
                                ...
                                @endif --}}
                                        ...
                                        @else
                                            <span class="new-price"
                                                style="font-size: 16px">{{ \AppHelper::instance()->rupiah($item->detail_produk->min('harga')) }}
                                                -
                                                {{ \AppHelper::instance()->rupiah($item->detail_produk->max('harga')) }}/seri</span>
                                        @endif
                                    </div>
                                ...
                                @endif --}}
                                        ...
                                        @else
                                            <span class="new-price"
                                                style="font-size: 14px">{{ \AppHelper::instance()->rupiah($item->detail_produk->min('harga')) }}
                                                -
                                                {{ \AppHelper::instance()->rupiah($item->detail_produk->max('harga')) }}/seri</span>
                                        @endif
                                    </div>
