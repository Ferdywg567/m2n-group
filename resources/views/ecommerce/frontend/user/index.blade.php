                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nomor_hp"
                                        value="{{ auth()->user()->no_hp }}" name="nomor_hp">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="kata_sandi_baru"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.btntambahalamat').on('click', function() {
                ...
                $.ajax({
                    url: "{{ asset('ecommerce/assets/alamat/data_provinsi.json') }}",
                    method: "GET",
                    success: function(response) {
                        for (let index = 0; index < response.length; index++) {
                            const element = response[index];
                            $("#provinsi").append('<option value="' + element.province_id +
                                '">' + element.province + '</option>');
                        }
                    }
                })
            })
            ...
            $('#provinsi').on('change', function() {
                ...
                $.ajax({
                    url: "{{ asset('ecommerce/assets/alamat/kota.json') }}",
                    method: "GET",
                    success: function(response) {

                        for (let index = 0; index < response.length; index++) {
                            const element = response[index];
                            if (element.province_id === id) {

                                $("#kota").append('<option value="' + element.id + '">' +
                                    element.type + ' ' + element.name + '</option>');
                            }
            ...
            $('#kota').on('change', function() {
                ...
                $('#kecamatan').append('<option value="">Pilih Kecamatan</option>')
                $.ajax({
                    url: "{{ asset('ecommerce/assets/alamat/kecamatan.json') }}",
                    method: "GET",
                    success: function(response) {
                        // console.log(response);
                        for (let index = 0; index < response.length; index++) {
                            const element = response[index];
                            if (element.regency_id === id) {
                                console.log(element);
                        ...
                        if (response.status) {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    for (let index = 0; index < response.length; index++) {
                                        const element = response[index];
                                        if(element.province_id === data.provinsi_id.toString()){
                                            $("#provinsi").append('<option selected value="' + element.province_id +
                                            '">' + element.province + '</option>');
                                        }else{
                                            $("#provinsi").append('<option value="' + element.province_id +
                                            '">' + element.province + '</option>');
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    for (let index = 0; index < response.length; index++) {
                                        const element = response[index];
                                        if (element.id === data.kota_id.toString() && element.province_id === data.provinsi_id.toString()) {
                                            $("#kota").append('<option selected value="' + element.id + '">' +
                                                element.type + ' ' + element.name + '</option>');
                                        }else if(element.province_id === data.provinsi_id.toString()){
                                            $("#kota").append('<option value="' + element.id + '">' +
                                                element.type + ' ' + element.name + '</option>');
                                        }
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    for (let index = 0; index < response.length; index++) {
                                        const element = response[index];
                                        if (element.id === data.kecamatan_id.toString() && element.province_id === data.provinsi_id.toString() && element.regency_id === data.kota_id.toString()) {
                                            $("#kecamatan").append('<option selected value="' + element.id + '"> ' + element.name + '</option>');
                                        }else if(element.province_id === data.provinsi_id.toString() && element.regency_id === data.kota_id.toString()){
