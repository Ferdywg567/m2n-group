...
<div id="non-printable">
    <section class="section">
        <div class="section-header ">
            ...
            <h1 class="ml-2">Edit Data | Warehouse</h1>
        </div>
        <div class="section-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <form action="{{route('warehouse.warehouse.update',[$warehouse->id])}}" method="post">
                            @csrf
                            @method('put')
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="number" class="form-control" required id="harga_produk"
                                                    value="{{$warehouse->harga_produk}}" name="harga_produk">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">/pcs</div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <a type="button" class="btn btn-secondary"
                                            href="{{route('warehouse.warehouse.index')}}">Batal</a>
