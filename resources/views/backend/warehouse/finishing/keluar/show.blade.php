                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" required id="tanggal_selesai"
                                                    readonly name="tanggal_selesai" value="{{ $finish->tanggal_selesai }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="number" class="form-control" required
                                                        id="jumlahdiretur" readonly name="jumlahdiretur[]"
                                                        value="{{ $item->jumlah }}">
                                                </div>
                                            </div>
                                            @if ($loop->iteration % 6 == 0)
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="keterangan_diretur" readonly name="keterangan_diretur" rows="3">{{ $finish->keterangan_diretur }}</textarea>
                                            </div>
                                        ...
                                        @forelse ($finish->finish_dibuang as $item)
                                            <div class="col-md-2">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="number" class="form-control" required
                                                        id="jumlahdibuang" readonly name="jumlahdibuang[]"
                                                        value="{{ $item->jumlah }}">
                                                </div>
                                            </div>
                                            @if ($loop->iteration % 6 == 0)
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="keterangan_dibuang" readonly name="keterangan_dibuang" rows="6">{{ $finish->keterangan_dibuang }}</textarea>
                                            </div>
                                        </div>
                                    </div>
