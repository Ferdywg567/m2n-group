                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="keterangan_diretur" name="keterangan_diretur" rows="3"></textarea>
                                            </div>
                ...
                if (id != '') {
                    $.ajax({
                        ...
                        if (response.status) {
                            ...
                            $('#barang_siap_qc').val(data.barang_siap_qc)
                            ...
                            var content = "";
                            content +=
                                ' <label for="ukuran" class="text-dark">Ukuran Lolos Sortir</label>'
                            detail_finish.forEach((result, i) => {
                                ...
                                content += '<div class="col-md-2">' +
                                    '<input type="hidden" name="dataukuran[]" value="' +
                                    result.ukuran + '">' +
                                    '<div class="input-group mb-2">' +
                                    '<div class="input-group-prepend">' +
                                    '<div class="input-group-text">' + result.ukuran +
                                    '</div>' +
                                    '</div>' +
                            ...
                            detail_finish.forEach((result, i) => {
                                ...
                                content += '<div class="col-md-2">' +
                                    '<input type="hidden" name="dataukurandiretur[]" value="' +
                                    result.ukuran + '">' +
                                    '<div class="input-group mb-2">' +
                                    '<div class="input-group-prepend">' +
                                    '<div class="input-group-text">' + result.ukuran +
                            ...
                            var content = "";
                            content +=
                                ' <label for="ukurangdibuang" class="text-dark">Ukuran yang Dibuang</label>'
                            detail_finish.forEach((result, i) => {
                                if (i == 0) {
                                    content += '<div class="row">'
                                }
                                ...
                                content += '<div class="col-md-2">' +
                                    '<input type="hidden" name="dataukurandibuang[]" value="' +
                                    result.ukuran + '">' +
                                    '<div class="input-group mb-2">' +
                                    '<div class="input-group-prepend">' +
                                    '<div class="input-group-text">' + result.ukuran +
