        ...
        <section class="section">
            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form action="{{ route('warehouse.finishing.update', [$finish->id]) }}" id="formProduk"
                                method="post">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" value="{{ $finish->tanggal_qc }}"
                                                    required id="tanggal_mulai_sortir" name="tanggal_mulai_sortir">
                                            </div>
                                        </div>
        ...
        $(document).ready(function() {
            ...
            $('form[id=formProduk]').submit(function() {
                ...
                if (parseInt(barang_siap_qc) != parseInt(jumlah)) {
                    iziToast.error({
                        title: 'Yeay!',
                        message: 'Jumlah ukuran harus sesuai dengan stok siap sortir',
                        position: 'topRight'
                    });
                    $('#dataalert').show()
