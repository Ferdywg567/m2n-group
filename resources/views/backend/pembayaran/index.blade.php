                                            ...
                                            <tbody id="">
                                                @forelse ($jahit as $item)
                                                    <tr>
                                                        ...
                                                        <td>Rp. {{ number_format($item->sisa_bayar, 0, ',', '.') }}</td>
                                                        <td>
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            let dt_tabeljahit = $('#tabeljahit').DataTable()
            let dt_tabelcuci = $('#tabelcuci').DataTable()

            dt_tabeljahit.on('order.dt search.dt', function() {
                let i = 1;

                dt_tabeljahit.cells(null, 0, {
                    search: 'applied',
                    order: 'applied'
                }).every(function(cell) {
                    this.data(i++);
            ...
            dt_tabelcuci.on('order.dt search.dt', function() {
                let i = 1;

                dt_tabelcuci.cells(null, 0, {
                    search: 'applied',
                    order: 'applied'
                }).every(function(cell) {
                    this.data(i++);
