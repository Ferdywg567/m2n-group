...
<div id="non-printable">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" data-toggle="modal"
                                            data-target="#perbaikanMasuk">perbaikanan Masuk</a>
                                        <a class="dropdown-item" href="#" data-toggle="modal"
                                            data-target="#perbaikanKeluar">perbaikanan Keluar</a>
                                    ...
                                    <table class="table table-hover" id="tabelbahanmasuk">
                                        ...
                                        <tbody id="">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item->no_surat}}</td>
                                                <td>
                                                    @if ($item->status_perbaikan == 'belum perbaikan')
                                                    <span
                                                        class="badge badge-secondary text-dark">{{$item->status_perbaikan}}</span>
                                                    @elseif ($item->status_perbaikan == 'selesai')
                                                    <span
                                                        class="badge badge-success text-dark">{{$item->status_perbaikan}}</span>
                                                    @else
                                                    <span
                                                        class="badge badge-warning text-dark">{{$item->status_perbaikan}}</span>
                                                    @endif
                                                </td>
                                                <td>
 ...
 --}}
    ...
    <div class="modal fade" id="perbaikanMasuk" tabindex="-1" role="dialog" aria-labelledby="perbaikanMasukLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="perbaikanMasukLabel">Input Data [perbaikan Masuk]</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form id="formperbaikanMasuk">
                    <div class="modal-body">
                        <div id="alert-perbaikan-masuk">

                        </div>
                        <input type="hidden" name="status" value="perbaikan masuk">
    ...
    <div class="modal fade" id="perbaikanKeluar" tabindex="-1" role="dialog" aria-labelledby="perbaikanKeluarLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="perbaikanKeluarLabel">Input Data [perbaikan Keluar]</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form id="formperbaikanKeluar">
                    <div class="modal-body">
                        <div id="alert-perbaikan-keluar">

                        </div>
                        <input type="hidden" name="status" value="perbaikan keluar">
