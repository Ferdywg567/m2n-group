                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="keterangan_tailoring"
                                                name="keterangan_tailoring" readonly
                                                rows="3">{{$jahit['keterangan']}}</textarea>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="keterangan_washing"
                                                name="keterangan_washing" readonly
                                                rows="3">{{$cuci['keterangan']}}</textarea>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" readonly
                                                value="{{$repair->tanggal_selesai}}" required id="tanggal_selesai"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" readonly
                                                value="{{$repair->tanggal_kirim}}" required id="tanggal_kirim"
                                                name="tanggal_kirim">
                                        </div>
                                    </div>
                                </div>
