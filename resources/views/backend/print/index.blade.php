...
@section('content')
    ...
    <div id="non-printable">
        <form id="formPrint" method="get" target="_blank"
            action="@if (auth()->user()->hasRole('production')) {{ route('print.export') }}
        @elseif (auth()->user()->hasRole('warehouse'))
        {{ route('warehouse.print.export') }} @endif">
            @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" required id="dari"
                                                    name="dari">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" required id="sampai"
                                                    name="sampai">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                ...
                {{-- <div class="col-md-6">
                    <div class="card tinggi_card">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title right mr-2">M2N Group System</h5>
                        ...
                        success: function(data) {
                            if (data.status) {
                                ...
                                dataprint.forEach((element, i) => {
                                    ...
                                    if (title != undefined) {
                                        htmldata +=
                                            '<div class="col-md-6"><div class="card tinggi_card"><div class="card-body"><h5 class="card-title right mr-2">M2N Group System</h5><hr><div class="row ml-2"><div class="col-md-3"><span  class="btn btn-primary">' +
                                            element.icon + ' ' + element.menu +
                                            '</span></div></div><table class="table" ><tbody>'
