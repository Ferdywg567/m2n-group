                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="{{$cuci->tanggal_masuk}}" required id="tanggal_masuk"
                                                name="tanggal_masuk">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="{{$cuci->tanggal_cuci}}" required id="tanggal_cuci"
                                                name="tanggal_cuci">
                                        </div>
                                    </div>
