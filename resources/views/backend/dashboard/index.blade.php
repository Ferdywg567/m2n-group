            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="card card-statistic-1" style="height: 14.5rem">
                        ...
                        border-radius: 8px;">
                                    <img src="{{ asset('assets/icon/t-shirt-fill-biru.png') }}" alt=""
                                        srcset="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card card-statistic-1" style="height:100px;">
                                ...
                                <div class="card-icon mt-2"
                                    style="background-color: rgba(176, 84, 222, 0.30);
                            border-radius: 8px;">
                                    <img src="{{ asset('assets/icon/shirt-fill-purple.png') }}" alt=""
                                        srcset="">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-statistic-1">
                                <div class="card-icon"
                                    style="background-color: rgba(92, 200, 250, 0.3);
                        border-radius: 8px;">
                                    <img src="{{ asset('assets/icon/hand-coin-fill-biru.png') }}" alt=""
                                        srcset="">
                                </div>
                                <div class="card-wrap">
                                    <div class="card-header">
                ...
                <div class="col-md-3">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-statistic-1">
                                <div class="card-icon"
                                    style="background-color: rgba(255, 204, 0, 0.30);
                        border-radius: 8px;">
                                    <img src="{{ asset('assets/icon/scissors-cut-fill-kuning.png') }}" alt=""
                                        srcset="">
                                </div>
                                <div class="card-wrap">
                                    <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        border-radius: 8px;">
                                    <img src="{{ asset('assets/icon/search-eye-fill-hijau.png') }}" alt=""
                                        srcset="">
                                </div>
                                <div class="card-wrap">
                                    <div class="card-header">
                ...
                <div class="col-md-3">
                    <div class="row">
                        ...
                        border-radius: 8px;">
                                    <img src="{{ asset('assets/icon/user-settings-fill-orange.png') }}" alt=""
                                        srcset="">
                                </div>
                                <div class="card-wrap">
                                    <div class="card-header">
                                    ...
                                    <div class="card-body">
                                        <h4 id="berhasil_jahit" class="label-data" style="margin-top: 6px !important"> 0
                                        </h4>
                                        <div style="margin-top: -10px !important">
                                            <span class="size15">pcs</span>
                                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('potong.index') }}">Lihat Semua <i
                ...
                var table_cutting = $('#table-cutting').DataTable({
                    ...
                    "rowCallback": function(row, data, index) {
                        ...
                        if (data.status_potong == 'belum potong') {
                            datahtml = '<span class="badge badge-secondary text-dark">' + data
                                .status_potong + '</span>';
                        } else if (data.status_potong == 'selesai') {
                            datahtml = '<span class="badge badge-success text-dark">' + data.status_potong +
                                '</span>';
                        } else if (data.status == 'potong keluar') {
                            datahtml = '<span class="badge badge-success text-dark">' + data.status +
                                '</span>';
                        } else {
                            datahtml = '<span class="badge badge-warning text-dark">' + data.status_potong +
                                '</span>';
                        }
                ...
                var table_jahit = $('#table-jahit').DataTable({
                    ...
                    "rowCallback": function(row, data, index) {
                        ...
                        if (data.status_jahit == 'belum jahit') {
                            ...
                            datahtml = '<span class="badge badge-success text-dark">' + data.status_jahit +
                                '</span>';
                        } else {
                            datahtml = '<span class="badge badge-warning text-dark">' + data.status_jahit +
                                '</span>';
                        }
                ...
                var table_cuci = $('#table-cuci').DataTable({
                    ...
                    "rowCallback": function(row, data, index) {
                        ...
                        if (data.status_cuci == 'belum cuci') {
                            datahtml = '<span class="badge badge-secondary text-dark">' + data.status_cuci +
                                '</span>';
                        } else if (data.status_cuci == 'selesai') {
                            datahtml = '<span class="badge badge-success text-dark">' + data.status_cuci +
                                '</span>';
                        } else {
                            datahtml = '<span class="badge badge-warning text-dark">' + data.status_cuci +
                                '</span>';
                        }
