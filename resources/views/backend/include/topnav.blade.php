...
<ul class="navbar-nav navbar-right mr-3">
    <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg beep" aria-expanded="true"><img src="{{asset('assets/icon/notification-fill.png')}}" alt="" srcset=""></a>
